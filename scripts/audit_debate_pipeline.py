...
async def run_audit():
    ...
    almas = [
        ...
        create_mock_alma("a4", "Metodólogo", "METHODOLOGICAL", "Você é um Metodólogo de Pesquisa. Ajude a operacionalizar tensões teóricas em desenhos de pesquisa empíricos.")
    ]
    ...
    logger.info("📡 Indexando Almas no Qdrant para teste semântico...")
    for alma in almas:
