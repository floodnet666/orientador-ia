...
5. SEM METALINGUAGEM: Não diga "como Foucault eu diria" ou "concordo com Byung-Chul". Apenas entre na arena teórica e debata.
"""
...
"""
        ...
        prompt2 = f"{canvas_context}\n\nDiscussão até agora:\n{content1}\n\n{DEBATE_CORE_RULES}\n\nComplemente com sua perspectiva teórica, reforçando a aderência aos objetivos do projeto."
        ...
        prompt3 = f"{canvas_context}\n\nDebate até agora:\n{content1}\n{content2}\n\n{DEBATE_CORE_RULES}\n\nAntagonize ou ataque os pontos anteriores sob a ótica do Problema de pesquisa."
        ...
        prompt4 = f"{canvas_context}\n\nDebate completo:\n{content1}\n{content2}\n{content3}\n\n{DEBATE_CORE_RULES}\n\nComo Metodólogo, sintetize e proponha um Desenho de Pesquisa textual que resolva o Problema apresentado."
