...
async def create_alma(
    ...
    # Centralização de Sincronia: Indexação e Registro em Memória
    if alma.is_approved:
        await sync_alma_to_system(alma)
...
async def update_alma(
    ...
    # Sincroniza se a alma estiver aprovada
    if alma.is_approved:
        await sync_alma_to_system(alma)
...
async def update_alma_prompt(
    ...
    # Sincroniza alteração do prompt
    if alma.is_approved:
        await sync_alma_to_system(alma)
